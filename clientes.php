...
<body>
  ...
  <div class="container">
    ...
    <input type="email" class="form-control" name="newcorreo" id="newcorreo" placeholder="Correo" aria-label="Username" aria-describedby="addon-wrapping" maxlength="30">
    </div></li>
...
<div class="container">
  <ul class="list-group">
    <li class="list-group-item"><div class="input-group flex-nowrap">
      <span class="input-group-text" id="addon-wrapping"><h1><b>Modificar y/o Eliminar Cliente</b></h1></span>
    </div></li>
    <li class="list-group-item"><div class="input-group flex-nowrap">
      <span class="input-group-text" id="addon-wrapping">Buscar Clientes</span>
      <input type="text" class="form-control" name="nombus" id="nombus" placeholder="Usuario" aria-label="Username" aria-describedby="addon-wrapping">
    </div></li>
    <li class="list-group-item"><div class="input-group flex-nowrap">
      <span class="input-group-text" id="addon-wrapping">Cliente</span>
      <input type="text" class="form-control" name="txtnom" id="txtnom" value="<?php echo $nombre2?>" placeholder="Cliente" aria-label="Username" aria-describedby="addon-wrapping">
    </div></li>
    <li class="list-group-item"><div class="input-group flex-nowrap">
      <span class="input-group-text" id="addon-wrapping">Telefono</span>
      <input type="text" class="form-control" name="txtsel" id="txtsel" value="<?php echo $telefono2?>" placeholder="Telefono" aria-label="Username" aria-describedby="addon-wrapping">
    </div></li>
    <li class="list-group-item"><div class="input-group flex-nowrap">
      <span class="input-group-text" id="addon-wrapping">Correo</span>
      <input type="text" class="form-control" name="txtcor" id="txtcor" value="<?php echo $correo2?>" placeholder="Correo" aria-label="Username" aria-describedby="addon-wrapping">
    </div></li>
    <li class="list-group-item">
      <button type="submit" name="accion" value="buscar" class="btn btn-info">Buscar</button>  
      <button type="submit" name="accion" value="modificar" class="btn btn-warning" onclick="return confirm('¿Estás seguro de que quieres modificar este cliente?')">Modificar</button> 
      <button type="submit" name="accion" value="eliminar" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que quieres eliminar este cliente?')">Eliminar</button>
    </li>
